...
var PluginManager = class {
  ...
  */
    ...
    if (res.length) {
      ...
      for (const p of res) {
        ...
        if (fs2.existsSync(pluginDest)) {
          ...
          console.log(version, version, buildInPluginVersion, (0, import_compare_versions.compareVersions)(version, buildInPluginVersion));
  ...
  async getAvailablePlugins() {
    try {
      const response = await import_axios.default.get(`${this.config.pluginRegistry}/plugins`, {
  ...
  async getPluginDetails(pluginName) {
    ...
    try {
      ...
      if (import_axios.default.isAxiosError(error) && ((_a = error.response) == null ? void 0 : _a.status) === 404) {
        return null;
      }
      throw new PluginError(
        pluginName,
  ...
  async installPlugin(pluginPackage, options) {
    ...
    try {
      ...
      if (((_a = this.config.security) == null ? void 0 : _a.validateChecksum) && pluginPackage.sha256) {
        const hash = (0, import_crypto.createHash)("sha256").update(response.data).digest("hex");
